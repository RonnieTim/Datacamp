...
plt.show()
-------
 """ Visualising outliers - Visualizing multiple variables with boxplots"""
...
o2o = pd.merge(left=survey, right=visited, left_on='taken', right_on='ident')
print(o2o.head())
m2m = pd.merge(left=o2o, right=site, left_on='site', right_on='name')
print(m2m)
----------
